...
| `test_warp_scheduler.cpp` | 11 | Issues from buffer, skips empty, scoreboard stall, VDOT8 rd-as-source hazard, opcoll-busy stall, unit-busy stall, writeback-bitmap contention including non-default multiply pipeline depth, RR fairness, committed scheduler diagnostics, scoreboard-pending-on-issue, idle pointer advance. |
