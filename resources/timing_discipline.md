...
- **Phase 9** (landed): Cache external boundary discipline. The cache subsystem
  ...
  - Cache internal hardware state (`tags_`, `mshrs_`, `write_buffer_`)
    ...
    (Superseded for `tags_` by the registered-tag-array change — see
    below.)
